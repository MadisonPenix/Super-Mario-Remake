...
{
    public class FireLuigiStateMachine : AbstractBigStateMachine
    {
        private ISprite[] attStates;

        public FireLuigiStateMachine(IMario player, bool faceLeft, bool isRunning, bool isJumping, bool isCrouching)
        {
            this.Player = player;
