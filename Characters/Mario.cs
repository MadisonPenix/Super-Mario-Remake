...
{
    public class Mario : IMario, IPhysicsObject
    {
        ...
        private void CreateItemDictionary()
        {
            ...
            Items.Add("Mushroom", typeof(BigMarioStateMachine));
            Items.Add("Fire", typeof(FireMarioStateMachine));
        ...
        public void Reset()
        {
            state = new RegMarioStateMachine(this, MarioUtility.Instance.INIT_FACE_LEFT, false, false);
            health = MarioUtility.Instance.REG_HEALTH;
        ...
        {
            if (state is not RegMarioStateMachine)
            {
        ...
        {
            return new Mario((int)location.X, (int)location.Y);
        }
    }
}